...
// in todays_rosary/test/helpers/test_helpers.dart.
...
import 'package:todays_rosary/services/litcal_api_service.dart' as _i10;
...
class _FakeRosaryDay_1 extends _i1.SmartFake implements _i3.RosaryDay {
  _FakeRosaryDay_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
/// A class which mocks [MysteryService].
///
/// See the documentation for Mockito's code generation for more information.
class MockMysteryService extends _i1.Mock implements _i9.MysteryService {
  @override
  List<_i9.Mystery> fetchMystery(String? mystery) => (super.noSuchMethod(
        Invocation.method(
          #fetchMystery,
          [mystery],
        ),
        returnValue: <_i9.Mystery>[],
        returnValueForMissingStub: <_i9.Mystery>[],
      ) as List<_i9.Mystery>);
}

/// A class which mocks [LitcalApiService].
///
/// See the documentation for Mockito's code generation for more information.
class MockLitcalApiService extends _i1.Mock implements _i10.LitcalApiService {
  @override
  _i7.Future<_i2.File> writeJson(dynamic litCal) => (super.noSuchMethod(
        Invocation.method(
          #writeJson,
          [litCal],
        ),
  ...
  @override
  _i7.Future<String> readLitCal() => (super.noSuchMethod(
        Invocation.method(
          #readLitCal,
          [],
        ),
  ...
  @override
  _i7.Future<List<_i10.LitCalDay>> getLitCalDays() => (super.noSuchMethod(
        Invocation.method(
          #getLitCalDays,
          [],
        ),
        returnValue: _i7.Future<List<_i10.LitCalDay>>.value(<_i10.LitCalDay>[]),
        returnValueForMissingStub:
            _i7.Future<List<_i10.LitCalDay>>.value(<_i10.LitCalDay>[]),
      ) as _i7.Future<List<_i10.LitCalDay>>);
}

/// A class which mocks [RosaryDayService].
///
/// See the documentation for Mockito's code generation for more information.
class MockRosaryDayService extends _i1.Mock implements _i3.RosaryDayService {
  @override
  _i7.Future<_i3.RosaryDay> getRosaryDay() => (super.noSuchMethod(
        Invocation.method(
          #getRosaryDay,
          [],
        ),
        returnValue: _i7.Future<_i3.RosaryDay>.value(_FakeRosaryDay_1(
          this,
          Invocation.method(
            #getRosaryDay,
            [],
        ...
        returnValueForMissingStub:
            _i7.Future<_i3.RosaryDay>.value(_FakeRosaryDay_1(
          this,
          Invocation.method(
            #getRosaryDay,
            [],
      ...
      ) as _i7.Future<_i3.RosaryDay>);
}

/// A class which mocks [PrayersService].
///
/// See the documentation for Mockito's code generation for more information.
class MockPrayersService extends _i1.Mock implements _i11.PrayersService {
  @override
  Map<String, String> get prayers => (super.noSuchMethod(
        Invocation.getter(#prayers),
        returnValue: <String, String>{},
        returnValueForMissingStub: <String, String>{},
      ) as Map<String, String>);

  @override
  String fetchPrayer(String? prayer) => (super.noSuchMethod(
        Invocation.method(
          #fetchPrayer,
          [prayer],
        ),
